...
function WinnerIS(name){
  alert("Congratulations, " + name + " wins!");
  alert("Better luck next time, " + (name === "White" ? "Black" : "White"));
  resetGame();
}
...
function checkForCheck() {
  if (inTurn === "black") {
    ...
    if (checkOrNot) {
     ...
     //winner decide cheyataniki
     if(globalPiece.white_king.current_position==null)
     {
       WinnerIS("Black");
     }
    ...
    //winner decide cheyataniki
    if(globalPiece.black_king.current_position==null)
    {
      WinnerIS("White");
    }
...
// //Here is WHITE pawn event listener
...
//       // if(hightlight_state) clearHighlight();
...
// //Here is BLACK pawn event listener
