import {
  ...
  function pawnPromotion(color, callback, id) {
    ...
    rook.src = `../Collections/Images/pieces/${color}/rook.png`;
  
    const knight = document.createElement("img");
    knight.onclick = knightCallback;
    knight.src = `../Collections/Images/pieces/${color}/knight.png`;
  
    const bishop = document.createElement("img");
    bishop.onclick = bishopCallback;
    bishop.src = `../Collections/Images/pieces/${color}/bishop.png`;
  
    const queen = document.createElement("img");
    queen.onclick = queenCallback;
    queen.src = `../Collections/Images/pieces/${color}/queen.png`;
